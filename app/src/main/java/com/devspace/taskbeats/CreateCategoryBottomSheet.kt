...
class CreateCategoryBottomSheet(
    ...
    override fun onCreateView(
        ...
        val btnCreate = view.findViewById<Button>(R.id.create_category_button)
        val tieCategoryName = view.findViewById<TextInputEditText>(R.id.tie_create_category_name)
